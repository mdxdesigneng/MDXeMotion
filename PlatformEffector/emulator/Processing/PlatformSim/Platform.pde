static class PlatformDef {
  ...
  float scale;
  // Dimensions
   float SCALE_INITIAL_HEIGHT;
   float SCALE_BASE_RADIUS;
   float SCALE_PLATFORM_RADIUS;
   float SCALE_LEG_LENGTH ;
   float SCALE_HORN_LENGTH;
}
...
static final PlatformDef ServoPlatformDef = new  PlatformDef();
  static {
    ...
    ServoPlatformDef.SCALE_INITIAL_HEIGHT = 200;
    ServoPlatformDef.SCALE_BASE_RADIUS = 70;
    ServoPlatformDef.SCALE_PLATFORM_RADIUS = 70;
    ServoPlatformDef.SCALE_LEG_LENGTH = 200;    
    ServoPlatformDef.SCALE_HORN_LENGTH = 30;
  } 


static final PlatformDef ChairPlatformDef = new  PlatformDef();
  static {
    ChairPlatformDef.baseAngles = new float[] {147, 154, 266, 274, 26, 33 };
    ChairPlatformDef.platformAngles =  new float[]  { 140, 207, 226, 314, 334, 40 };    
    // Dimensions
    ChairPlatformDef.scale = 0.4;
    ChairPlatformDef.SCALE_INITIAL_HEIGHT = 700;
    ChairPlatformDef.SCALE_BASE_RADIUS = 400;
    ChairPlatformDef.SCALE_PLATFORM_RADIUS = 400;
    ChairPlatformDef.SCALE_LEG_LENGTH = 800;    
    ChairPlatformDef.SCALE_HORN_LENGTH = 0;
  } 
...
class Platform {
  ...
  public Platform(PlatformDef def) {
    ...
    initialHeight = new PVector(0, 0, scale*def.SCALE_INITIAL_HEIGHT);
